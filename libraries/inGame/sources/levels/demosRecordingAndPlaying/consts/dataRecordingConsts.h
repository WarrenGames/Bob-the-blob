...
namespace demosData{
	...
	constexpr int EnemyBobVulnerabilityDelay = -53;
	constexpr int GameEvents = -60;
	constexpr int LevelWonEvents = -61;
	constexpr int GreenOrb = -70;
	constexpr int GreenOrbPlayerPowerSwitching = -71;
	constexpr int GreenOrbPowerDuration = -72;
	constexpr int CactusEvent = -73;
